...
total = sum(price * qty for _, price, qty in stocks)      # 메모리에 값 1개만 잡힘 ----> 메모리 이용 측면에서 더 효율적
total = sum([price * qty for _, price, qty in stocks])    # 리스트를 만들어 놓고 더함
