...
print(s.find("Java"))               # 인덱스 반환 ( 없으면 ) -1 return
...
# 판별 문자열 메소드 (isXXX())
print("123".isdigit())              # 숫자이면 True  # 음수, 소수 판별 불가능 ---> false 나옴
# print("一".isnumeric())              # 숫자이면 True   # 더 넓은 숫자 범위를 포함(한자 가능, 한글은 불가능)
