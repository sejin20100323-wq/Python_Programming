...
def swap(a, b):         # a, b -> 지역 변수
    print(id(a), id(b))     # id: 참조값
    a, b = b, a
    print(a, b)
...
num = [1]
append_item(num)
print(num)          # append가 원본을 바꿔서 함수가 종료된 후에도 [1, 2]가 나오게 된다
...
# 점화식: n if n <= 1 else fibo(n-1) + fibo(n-2)
